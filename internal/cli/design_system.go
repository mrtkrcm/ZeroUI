...
func newDesignSystemCmd(getContainer func() (*container.Container, error)) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "design-system",
...
Examples:
  ...
  zeroui showcase`,
	...
	cmd.Flags().BoolP("interactive", "i", true, "enable interactive mode (default: true)")
	return cmd
}
